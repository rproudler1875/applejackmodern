...
hook.Add("ShowSpare1", "AJMRP_OpenMenu", function()
    print("[AJMRP] ShowSpare1 hook triggered (F1 pressed)")
    CreateF1Menu()
end)

-- Temporary: Bind to F2 for testing
hook.Add("ShowSpare2", "AJMRP_OpenMenu_F2", function()
    print("[AJMRP] ShowSpare2 hook triggered (F2 pressed)")
    CreateF1Menu()
end)
